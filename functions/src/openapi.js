    ...
    schemas: {
      ...
      Site: {
        ...
        properties: {
          ...
          country: { type: 'string' },
          countryCode: { type: 'string' },
          goLiveDate: { type: 'string', format: 'date', nullable: true },
      ...
      Stats: {
        ...
        properties: {
          ...
          trials: { type: 'object', properties: { total: { type: 'integer' } } },
          sites: { type: 'object', properties: { total: { type: 'integer' } } },
          subjects: { type: 'object', properties: { total: { type: 'integer' } } },
          reviews: {
            type: 'object',
            properties: {
      ...
      QueryFilter: {
        ...
        properties: {
          ...
          searchTerm: {
            type: 'string',
            description: 'Search term for filename, subject number, etc.'
          },
          sortBy: {
            type: 'string',
  ...
  paths: {
    '/api/v1/assets': {
      get: {
        ...
        parameters: [
          ...
          { name: 'trial_id', in: 'query', schema: { type: 'integer' } },
    ...
    '/api/v1/assets/query': {
      post: {
        ...
        description: 'Advanced query endpoint supporting multi-select filters, date ranges, and full-text search. Use this endpoint for dashboard filtering.',
        tags: ['Assets'],
        requestBody: {
          required: true,
          content: {
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    meta: { $ref: '#/components/schemas/Pagination/properties/meta' },
                    links: { $ref: '#/components/schemas/Pagination/properties/links' }
                  }
                }
              }
            }
    ...
    '/api/v1/trials/{id}': {
      get: {
        ...
        tags: ['Trials'],
        parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Trial details' }, 404: { description: 'Trial not found' } }
      }
    },
    '/api/v1/sites': {
      get: {
    ...
    '/api/v1/sites/{id}': {
      get: {
        ...
        tags: ['Sites'],
        parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Site details' }, 404: { description: 'Site not found' } }
      }
    },
    '/api/v1/subjects': {
      get: {
        ...
        parameters: [
          ...
          { name: 'trial_id', in: 'query', schema: { type: 'integer' } },
          { name: 'site_id', in: 'query', schema: { type: 'integer' } },
          { name: 'arm_id', in: 'query', schema: { type: 'integer' } },
    ...
    '/api/v1/subjects/{id}': {
      get: {
        ...
        tags: ['Subjects'],
        parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Subject details' }, 404: { description: 'Subject not found' } }
      }
    },
    '/api/v1/procedures': {
      get: {
        ...
        parameters: [
          { $ref: '#/components/parameters/pageParam' },
          { $ref: '#/components/parameters/limitParam' },
          { name: 'subject_id', in: 'query', schema: { type: 'integer' } },
    ...
    '/api/v1/procedures/{id}': {
      get: {
        ...
        tags: ['Procedures'],
        parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Procedure details' }, 404: { description: 'Procedure not found' } }
      }
    },
    '/api/v1/events': {
      get: {
    ...
    '/api/v1/reviews': {
      get: {
        ...
        parameters: [
          ...
          { name: 'reviewed', in: 'query', schema: { type: 'boolean' } }
        ],
    ...
    '/api/v1/reviews/{id}': {
      get: {
        ...
        tags: ['Reviews'],
        parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Review details' }, 404: { description: 'Review not found' } }
      }
    },
    '/api/v1/comments': {
      get: {
    ...
    '/api/v1/comments/{id}': {
      get: {
        ...
        tags: ['Comments'],
        parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'integer' } }],
        responses: { 200: { description: 'Comment details' }, 404: { description: 'Comment not found' } }
      }
    },
    '/api/v1/users': {
      get: {
        ...
        parameters: [
          ...
          { $ref: '#/components/parameters/limitParam' },
          { $ref: '#/components/parameters/searchParam' },
          { name: 'activated', in: 'query', schema: { type: 'boolean' } }
        ],
    ...
    '/api/v1/stats': {
      get: {
        ...
        tags: ['Stats'],
        parameters: [
          { name: 'trial_id', in: 'query', schema: { type: 'integer' }, description: 'Filter by trial' }
        ],
