...
const COUNTRY_COORDINATES = {
    ...
    'North Macedonia': { lat: 41.512315, lng: 21.4254355 },
    ...
    'Turks and Caicos': { lat: 21.694025, lng: -71.797928 },
    ...
    'Caribbean Netherlands': { lat: 12.178361, lng: -68.238534 },
    'Unknown': { lat: 0, lng: 0 },
};
            ...
            try {
                ...
                const records = result.rows.map(row => {
                    ...
                    return {
                        ...
                        studyProcedureDate: row.study_procedure_date
                            ? new Date(row.study_procedure_date)
                                  .toISOString()
                                  .split('T')[0]
                            : '',
                        evaluator:
                        ...
                        uploadDate: row.upload_date
                            ? new Date(row.upload_date).toISOString()
                            : '',
                        uploadedBy:
