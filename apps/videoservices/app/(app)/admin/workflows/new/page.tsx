...
import type { FieldMappingMode } from '@cp/types';
...
export default function NewWorkflowPage() {
    ...
    const updateDestination = (id: string, updates: Partial<DestinationConfig>) => {
        ...
        <div className="max-w-2xl">
            <div className="mb-8">
                ...
                <p className="mt-1 text-sm text-neutral-500">
                    Define a new video processing workflow
                </p>
            </div>
