            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3 px-4 bg-chilli-red text-white rounded-lg font-semibold hover:bg-chilli-red-dark focus:outline-none focus:ring-2 focus:ring-chilli-red focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-colors"
                    >
                        {loading ? (
                            <>
                ...
                <div className="mt-8 pt-6 border-t border-neutral-200 text-center">
                    <p className="text-xs text-neutral-400">
                        Video processing workflow automation
                    </p>
                </div>
            </div>
        </div>
