...
export function IntegrationHealth() {
    ...
    const handleViewAsset = useCallback(
        (event: React.MouseEvent, asset: (typeof filteredRecords)[0]) => {
    ...
    const handleCountryClick = useCallback(
        (country: string) => {
            const countryAssets = filteredRecords.filter(
                r => r.siteCountry === country
            );
        ...
        <div className="flex flex-col gap-6">
            <div className="mb-2">
                ...
                <p className="text-neutral-500 text-sm">
                    System usage, evaluator activity, and geographic
                    distribution
                </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <WorldMap
                    countryData={countryDistribution}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center gap-3 p-4 bg-neutral-50 rounded-md border border-neutral-200">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="text-xs text-neutral-600 mt-0.5">
                                Operational - {processedCount} processed
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 p-4 bg-neutral-50 rounded-md border border-neutral-200">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="text-xs text-neutral-600 mt-0.5">
                                Active - {reviewedCount} reviews completed
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 p-4 bg-neutral-50 rounded-md border border-neutral-200">
