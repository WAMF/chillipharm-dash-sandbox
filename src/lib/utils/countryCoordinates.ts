export const countryCoordinates: Record<string, { lat: number; lng: number }> = {
  ...
  'North Macedonia': { lat: 41.5124, lng: 21.7465 },
  ...
  'Åland Islands': { lat: 60.1785, lng: 19.9156 },
  'Aland Islands': { lat: 60.1785, lng: 19.9156 },
  'British Indian Ocean Territory': { lat: -6.3432, lng: 71.8765 },
